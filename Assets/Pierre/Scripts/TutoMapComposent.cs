...
public class TutoMapComposent : MonoBehaviour
{
    ...
    private static TutoMapComposent _instance = null;

    public static TutoMapComposent Instance
    {
        get => _instance;
    }
    private void Awake()
    ...
    private IEnumerator waitforopen()
    {
        ...
        if (position == 100)
        {
            ...
            GameObject.Find("NOT").GetComponent<Text>().text = "Nombre de tour : " + TutoPhaseManager.Instance.numberOfTurn;
            ...
            if (TutoPhaseManager.Instance.numberOfTurn < TutoPhaseManager.Instance.numberOfTurnRecord || TutoPhaseManager.Instance.numberOfTurnRecord == 0)
            {
                PlayerPrefs.SetInt("NumberOfTurn", TutoPhaseManager.Instance.numberOfTurn);
            ...
            {
                GameObject.Find("OldRecord").GetComponent<Text>().text = "Record : " + TutoPhaseManager.Instance.numberOfTurnRecord;
            }
    ...
    private IEnumerator waitforclose()
    {
        ...
        Check();
        TutoGrid.Instance.deleteMap(true);
        Camera.main.GetComponent<TutoMoveCam>().replace();
    }
